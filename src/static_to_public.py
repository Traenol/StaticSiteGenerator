...
def generate_pages_recursive(base_path, dir_path_content, template_path, dest_dir_path):
    ...
    for item in os.listdir(dir_path_content):
        if str(item).endswith(".md"):
            ...
            generate_page(base_path, dir_path_content + "/" + item, template_path, dest_dir_path + "/" + file_name)
        if os.path.isdir(dir_path_content + '/' + item):
            generate_pages_recursive(base_path, dir_path_content + "/" + item, template_path, dest_dir_path + "/" + item)
